                                ...
                                <div class="cart-items">
                                    ...
                                    <div class="shopping-item">
                                        <div class="dropdown-cart-header">
                                            <span>{{\App\Facades\Repository\CartFacade::index()->count()}} Items</span>
                                            <a href="cart.html">View Cart</a>
                                        </div>
                                        <ul class="shopping-list">
                                            @foreach(\App\Facades\Repository\CartFacade::index() as $cart)
                                            <li>
                                        ...
                                        <div class="bottom">
                                            <div class="total">
                                                <span>Total</span>
                                                <span class="total-amount">${{\App\Facades\Repository\CartFacade::total() }}</span>
                                            </div>
                                            <div class="button">
