                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-images">
                            <main id="gallery">
                                <div class="main-img">
                                    <img src="{{$product['image_url']}}" id="current" alt="kkkkk">
                                </div>
                                <div class="images">
                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-info">
                            ...
                            <p class="category"><i class="lni lni-tag"></i> Drones:<a href="javascript:void(0)">{{$product['categoryName']}}</a></p>
                            <h3 class="price">{{$product['price']. App\Helper\Currency::getCurrencySymbolByCountry()}}<span>{{$product['comparePrice']}}</span></h3>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-12">
                                        <div class="button cart-button">
                                            <form action="{{route('carts.store')}}" method="post">
                                                @csrf
                                            <x-form.input name="quantity" value="1" type="number"/><br>
                                            <x-form.input name="product" value="{{ $product['id'] }}" type="hidden"/>
